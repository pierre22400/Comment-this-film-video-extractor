...
(Hors périmètre par conception : identification d'œuvre/personne, multi-images,
sous-titres, recherche Internet, anecdotes, commentaire — non implémentés
volontairement.)
...
- `pnpm test` : 3 fichiers, 21 tests, tous au vert.
